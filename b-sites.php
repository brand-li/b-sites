<?php
/**
 * Plugin Name: Brandli Sites
 * Description: The Complete Network Solution.
 * Plugin URI: https://github.com/brand-li/b-sites
 ...
 * 
 * B-sites is distributed under the terms of the GNU General Public License as published by
